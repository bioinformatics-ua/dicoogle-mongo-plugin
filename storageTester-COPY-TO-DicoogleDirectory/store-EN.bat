...
java -jar DICOMTester-EN.jar -dir add %1
for /l %%I in (1,1,%2) do (
	java -jar DICOMTester-EN.jar -run store -log temp.txt
)
java -jar DICOMTester-EN.jar -dir del %1
echo Press a key only when indexing is finished
pause
java -jar readtimetocsv-EN.jar temp.txt %3